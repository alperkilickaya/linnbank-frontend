...
const RecentlyBestTransactions = () => {
  return (
    <>
      ...
      {/* <!--transection-area end--></tbody> */}
    </>
  );
};

export default RecentlyBestTransactions;
